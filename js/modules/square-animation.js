function squareAnimation(){
    ...
    let firstHeaderLi = document.querySelectorAll('.menu__list-item')[0];
    let arrHeaderLi = document.querySelectorAll('.menu__list-item');
    ...
    for(let key of arrHeaderLi){
        key.addEventListener('click', function(){
            for(let value of arrHeaderLi){
                value.querySelector('a').classList.remove('active-menu');
            }
            this.querySelector('a').classList.add('active-menu');
            calcPosition(this);
        });
    }
    ///////////////////////////////////////////////////////
